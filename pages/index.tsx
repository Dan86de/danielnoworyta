...
export default function Home() {
  return (
    <>
      <div
        className={`flex items-center justify-between mx-auto max-w-7xl px-4 sm:px-6 py-4 sm:py-6`}
      >
        <svg
          width="35"
          height="35"
      ...
      <div className="mx-auto max-w-7xl py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto">
          <h1
            className={`mt-1 text-4xl tracking-tight text-gray-900 sm:text-5xl lg:text-6xl ${geomanistMedium.variable} font-sans`}
          >
            There is some heading text about this page.
          </h1>
          <p
            className={`mx-auto mt-5 max-w-xl text-xl text-gray-500 ${geomanistMedium.variable} font-sans`}
          >
