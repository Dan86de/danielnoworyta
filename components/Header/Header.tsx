import { geomanistMedium, geomanistRegular } from "../../pages/fonts/fontUtils";
      ...
      <Popover className="relative">
        ...
        >
          <div className="flex items-center justify-center gap-2">
            ...
            <span
              className={`${geomanistMedium.variable} font-sans text-xl hidden sm:block`}
            >
              Daniel Noworyta
            </span>
          </div>
          ...
          <Popover.Overlay className="fixed inset-0 bg-primary/20 opacity-30" />
          <Transition
            as={Fragment}
          ...
          >
            <Popover.Panel className="absolute bg-white inset-x-0 top-0 px-4 py-4">
              ...
              <ul className="flex flex-col gap-10 mt-8 items-center text-textprimary">
                <Link href={NavigationLinks.HOME}>Home</Link>
                <Link href={NavigationLinks.BLOG}>Blog</Link>
                <Link href={NavigationLinks.ABOUT}>About</Link>
                <Link href={NavigationLinks.CONTACT}>Contact</Link>
